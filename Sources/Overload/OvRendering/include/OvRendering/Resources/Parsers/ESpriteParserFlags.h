...
{
	/**
	* Some flags that can be used for sprite parsing
	*/
	enum class ESpriteParserFlags : uint32_t
	{
		NONE						= 0x0,
	...
	inline ESpriteParserFlags operator~ (ESpriteParserFlags a) { return (ESpriteParserFlags)~(int)a; }
	inline ESpriteParserFlags operator| (ESpriteParserFlags a, ESpriteParserFlags b) { return (ESpriteParserFlags)((int)a | (int)b); }
	inline ESpriteParserFlags operator& (ESpriteParserFlags a, ESpriteParserFlags b) { return (ESpriteParserFlags)((int)a & (int)b); }
	inline ESpriteParserFlags operator^ (ESpriteParserFlags a, ESpriteParserFlags b) { return (ESpriteParserFlags)((int)a ^ (int)b); }
	inline ESpriteParserFlags& operator|= (ESpriteParserFlags& a, ESpriteParserFlags b) { return (ESpriteParserFlags&)((int&)a |= (int)b); }
	inline ESpriteParserFlags& operator&= (ESpriteParserFlags& a, ESpriteParserFlags b) { return (ESpriteParserFlags&)((int&)a &= (int)b); }
